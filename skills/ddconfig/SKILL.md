...
1. Edit the domain in the registration file following the editing rule in `mcp-settings.md`.
...
1. Tell the user the domain has been changed and to follow these steps:
